...
<header>
	 <div class="container1">
		  <img src="https://cdn.psychologytoday.com/sites/default/files/styles/og_image/public/field_blog_entry_teaser_image/2018-11/shutterstock_674652934.jpg?itok=riTx0Gbx" alt="Snow" style="width:100%; height: 15vw !important;">
		  <div class="centered">
     ...
     <div id="profile-pic">
     	 <img  src="profile_upload/<?php echo $profileid;?>/<?php echo $pic1;?>" >
   ...
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">View Profile</li>
         <li><a href="partner_preference.php?id=<?php echo $id;?>">Update Preference</a></li>
         		<li class="dropdown">
   	 	...
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
					 <ul class="slides">
						<li data-thumb="profile_upload/<?php echo $profileid;?>/<?php echo $pic1;?>">
							<img src="profile_upload/<?php echo $profileid;?>/<?php echo $pic1;?>" />
						</li>
						<li data-thumb="profile_upload/<?php echo $profileid;?>/<?php echo $pic2;?>">
							<img src="profile_upload/<?php echo $profileid;?>/<?php echo $pic2;?>" />
						</li>
						<li data-thumb="profile_upload/<?php echo $profileid;?>/<?php echo $pic3;?>">
							<img src="profile_upload/<?php echo $profileid;?>/<?php echo $pic3;?>" />
						</li>
						<li data-thumb="profile_upload/<?php echo $profileid;?>/<?php echo $pic4;?>">
							<img src="profile_upload/<?php echo $profileid;?>/<?php echo $pic4;?>" />
						</li>
					 </ul>
				  </div>
			</div>
