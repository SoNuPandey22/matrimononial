...
///reading partnerprefs from db
		...
		if($result){
			//if the result is found then render it to the database
			//and when the database is matched to the user and it can be seen to the unique.
...
<!--copied the data to the make up language-->
				    ...
				    <div class="basic_1-left">
				    	  <table class="table_working_hours">
				        	<tbody>
								...
								<tr class="opened">
									<!--data class open that is need to be opened-->
								...
								<tr class="opened">
									<!--on submit the data should be reached to the particular page-->
									...
									<td class="day_value closed">
										<div class="select-block1">
						                    <select name="country">
							                    ...
							                    <option value="Christian">Bangladesh</option>
